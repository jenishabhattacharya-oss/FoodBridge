...
class Donation(models.Model):
    ...
    food_photo_overview = models.ImageField(upload_to="private/donation_photos/%Y/%m/", blank=True)
    food_photo_closeup = models.ImageField(upload_to="private/donation_photos/%Y/%m/", blank=True)
    food_photo_label = models.ImageField(upload_to="private/donation_photos/%Y/%m/", blank=True)
    ...
    receipt_photo = models.ImageField(upload_to="private/ngo_receipts/%Y/%m/", blank=True)
